...
#
# $Id: genmipsimage.pl,v 1.1.1.1 2006/05/23 13:53:49 mainakc Exp $
#
...
for ($i=0; $i <= $#list; $i++) {
  ...
  open(OBJ,"mips-sgi-irix5-objdump -j $list[$i] --full-contents $tmpfile|");
...
sub read_section_headers {
  ...
  open(OBJ,"mips-sgi-irix5-objdump -h $file|");
