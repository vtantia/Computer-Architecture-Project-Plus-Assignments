...
typedef unsigned short mips_mode_t;
typedef unsigned short mips_nlink_t;
typedef int mips_dev_t;
typedef int mips_blksize_t;
typedef int mips_ino_t;
typedef int mips_off_t;
typedef int mips_blkcnt_t;
...
struct  mips_stat {
	...
	mips_blksize_t    st_blksize;
	mips_blkcnt_t    st_blocks;
