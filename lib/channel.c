 ...
 *  export license.
 *
 *  $Id: channel.c,v 1.1.1.1 2006/05/23 13:53:59 mainakc Exp $
 *
 *************************************************************************/
#include <stdio.h>
#include "thread.h"
...
extern thread_t *readyQh, *readyQt;

static void _ch_fsendul (ch_t *c, unsigned int *msg);
static void _ch_frecvul (ch_t *c, unsigned int *msg);
...
static thread_t *timeQh = NULL;
static thread_t *timeQt = NULL;
...
void ch_reset_color (void)
{
  ...
  ((thread_t*)current_process)->color = 0;
}
...
{
  ((thread_t*)current_process)->color = 2;
}

int ch_get_color (void)
{
  return ((thread_t*)current_process)->color;
}
...
static void _ch_frecvul (ch_t *c, unsigned int *msg)
{
  ...
  c->receiver = (thread_t*)current_process;
 ...
 *-------------------------------------------------------------------------
 */
static void _ch_sendul (ch_t *c, unsigned int *msg)
{
  thread_t *t;
  int id, id2;
...
static void _ch_recvul (ch_t *c, unsigned int *msg)
{
  thread_t *t, *s;
  int id, ind2;
