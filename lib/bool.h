 ...
 *
 *  $Id: bool.h,v 1.1.1.1 2006/05/23 13:53:59 mainakc Exp $
 *
 *************************************************************************/
#ifndef __BOOL_H__
#define __BOOL_H__

typedef unsigned int bool_var_t;
...
#define ASSIGN_LEAF(b,n) ((b)->id = ((b)->id & ~(1UL<<HIBIT_OFFSET))|(((unsigned int)n) << HIBIT_OFFSET))
...
typedef struct {
  unsigned int nelements;	/* number of elements in the hashtable */
...
typedef struct {
  ...
  unsigned int totvar;		/* total number of variables */
...
extern bool_list_t *bool_qlist (BOOL_T *, unsigned int, bool_var_t *);
