 ...
 *  export license.
 *
 *  $Id: sim.h,v 1.1.1.1 2006/05/23 13:53:59 mainakc Exp $
 *
 *************************************************************************/
#ifndef __SIM_H__
#define __SIM_H__
...
class SimObject {
 public:
  ...
  friend void SimCreateTask (SimObject *, char *, int);
...
#elif defined (ASYNCHRONOUS)
  thread_t *SimCore (void) { return t; }
#endif
private:
  int my_id;
...
void SimCreateTask (SimObject *s, char *name, int stksz = DEFAULT_STACK_SIZE);
