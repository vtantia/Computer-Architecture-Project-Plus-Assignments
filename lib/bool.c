 ...
 *
 *  $Id: bool.c,v 1.1.1.1 2006/05/23 13:53:59 mainakc Exp $
 *
 *************************************************************************/
#include <stdio.h>
...
#define PTR_TO_INT(b) ((unsigned int)(b))
#define PMIN(a,b) ((PTR_TO_INT(a) < PTR_TO_INT(b)) ? a : b)
#define PMAX(a,b) ((PTR_TO_INT(a) > PTR_TO_INT(b)) ? a : b)

static bool_t *freelist = NULL;
#ifdef PROFILE
static unsigned int nfreed = 0;
static unsigned int nbools = 0;
static unsigned int extrabools = 0;
#endif
...
static triplehash_t *thash_new (unsigned int sz)
{
  triplehash_t *t;
  unsigned int i;
...
static pairhash_t *hash_new (unsigned int sz)
{
  pairhash_t *p;
  unsigned int i;
...
static unsigned int hash (unsigned int sz, bool_t *v1, bool_t *v2)
{
  int i;
...
/*=======================================================================*/
static void msort (bool_var_t *v, bool_var_t *v1, unsigned int i, 
		       unsigned int n)
{
  unsigned int j, k, l;
 ...
 *-----------------------------------------------------------------------*/
bool_list_t *bool_qlist (BOOL_T *B, unsigned int n, bool_var_t *v)
{
  bool_list_t *l;
